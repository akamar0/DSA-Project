    ...
    cout << "==================== PLAYLIST MANAGER MENU ====================\n";
        ...
        switch (choice) {
            ...
            case 3: {
                ...
                if (s) {
                    playQueue.push(s);
                cout << s->title << " added to play queue.\n";
                } else {
            ...
            case 6:
                if (currentSong)
                    ...
                    cout << "Current song: " << currentSong->title << " - " << currentSong->artist << endl;
                else
                    cout << "No song is currently playing as of the moment.\n";
